<x-layout>
    @php $reserved_At = ((isset($clubReservations->reserved_At)) && (!is_null($clubReservations->reserved_At))) ? verta($clubReservations->reserved_At)->format('Y/m/d') : verta()->now()->format('Y/m/d')@endphp
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="top_content">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">خدمات ورزشی / رزروهای من / </span>معرفی نامه باشگاه</h4>
            <div class="alert alert-primary alert-dismissible d-flex align-items-center" role="alert">
                <h6 class="alert-heading mb-1"><i class="bx bx-xs bx-detail me-2"></i>
                    همکار ارجمند، در صورت لزوم می توانید با ارائه و یا ارسال تصویر این معرفی نامه به مدیر باشگاه از خدمات ورزشی مذکور استفاده نمایید.    </h6>
