...
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-semi-dark" data-assets-path="/assets/" data-template="vertical-menu-template">
  <head>
    ...
    <title>{{ config('app.name') }} - دسترسی مجاز نیست</title>
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-5">
          <img src="{{ asset('assets/img/illustrations/page-403-error-light.png') }}" alt="page-misc-not-authorized-light" width="450" class="img-fluid" data-app-light-img="illustrations/page-403-error-light.png" data-app-dark-img="illustrations/page-403-error-dark.png">
        </div>
      </div>
    </div>
    <!-- /Not Authorized -->
