    ...
    <div class="authentication-inner py-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-0 fw-semibold h5 mb-3">کلمه عبور جدید را وارد نمایید.</p>
                <form id="twoStepsForm" action="{{ route('password.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">

                        <div class="input-group input-group-merge mb-3 form-password-toggle">
                            <input  type="password" id="password" name="password" placeholder="کلمه عبور جدید" aria-describedby="password" class="form-control text-start
                        ">
                            <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            <span class="invalid-feedback" id="invalid_password"></span>
                        </div>

                        <div class="input-group input-group-merge mb-5 form-password-toggle">
                            <input  type="password" id="password_confirmation" name="password_confirmation" placeholder="تکرار کلمه عبور جدید" aria-describedby="password_confirmation" class="form-control text-start
                        ">
                            <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            <span class="invalid-feedback" id="invalid_password_confirmation"></span>
                        </div>
                        @error('password')
                    ...
                    <button class="btn btn-primary d-grid w-100" name="submit_mobile_paswword" type="submit">تایید و ورود</button>
                </form>
            </div>
        </div>
        <!-- / Two Steps Verification -->
