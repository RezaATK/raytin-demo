                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('id')" class="px-1" x-show="storeCategoryID" x-transition x-cloak>
                                <x-administrator.icons-sort column="شناسه" columnEn="storeCategoryID" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            @foreach ($storeCategories as $storeCategory)
                                <livewire:administrator.store-category.table-row
                                        :$storeCategory
                                        :key="$storeCategory->storeCategoryID"
