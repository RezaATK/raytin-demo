                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="d-flex gap-1">
                            ...
                            <div class="ms-2" x-show="show" x-transition>
                                ...
                                <x-administrator.show-hide-column fieldId="secondayUserNationalCode" fieldName="کد ملی رزرو شده" />
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('secondayUserNationalCode')" class="px-1" x-show="secondayUserNationalCode" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد ملی رزرو شده" columnEn="secondayUserNationalCode" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            @foreach ($reserves as $clubReservations)
                                <livewire:administrator.club.all-reservations.table-row
                                        :$clubReservations
