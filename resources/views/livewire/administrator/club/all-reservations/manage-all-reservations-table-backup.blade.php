                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="d-flex gap-1">
                            ...
                            <div class="ms-2" x-show="show" x-transition>
                                ...
                                <x-administrator.show-hide-column fieldId="PrimaryUserFullName" fieldName="نام و نام خانوادگی کارمند" />
                                <x-administrator.show-hide-column fieldId="primaryUserNationalCode" fieldName="کد ملی کارمند" />
                                ...
                                <x-administrator.show-hide-column fieldId="secondaryUserRelationship" fieldName="رزرو برای" />
                                <x-administrator.show-hide-column fieldId="secondaryUserFullName" fieldName="نام و نام خانوادگی" />
                                <x-administrator.show-hide-column fieldId="secondaryUserNationalCode" fieldName="کد ملی رزرو شده" />
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('PrimaryUserFullName')" class="px-1" x-show="PrimaryUserFullName" x-transition x-cloak>
                                <x-administrator.icons-sort column="نام و نام خانوادگی کارمند" columnEn="PrimaryUserFullName" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('primaryUserNationalCode')" class="px-1" x-show="primaryUserNationalCode" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد ملی کارمند" columnEn="primaryUserNationalCode" :$selectedColumn
                                                            :$descSort />
                            </th>
                            ...
                            <th wire:click="sort('secondaryUserRelationship')" class="px-1" x-show="secondaryUserRelationship" x-transition x-cloak>
                                <x-administrator.icons-sort column="رزرو برای" columnEn="secondaryUserRelationship" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('secondaryUserFullName')" class="px-1" x-show="secondaryUserFullName" x-transition x-cloak>
                                <x-administrator.icons-sort column="نام و نام خانوادگی" columnEn="secondaryUserFullName" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('secondaryUserNationalCode')" class="px-1" x-show="secondaryUserNationalCode" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد ملی رزرو شده" columnEn="secondaryUserNationalCode" :$selectedColumn
                                                            :$descSort />
                            </th>
                            ...
                            <th wire:click="sort('reservDate')" class="px-1" x-show="reservDate" x-transition x-cloak>
                                <x-administrator.icons-sort column="برای تاریخ" columnEn="reservDate" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            @foreach ($reserves as $clubReservations)
                                <livewire:administrator.club.manage-all-reservations-table-rows
                                        :clubReservations="$clubReservations"
                                        :key="$clubReservations->reservID"
                                        id="$clubReservations->reservID"
                                        />
                            @endforeach
                        @endif
                        </tbody>
