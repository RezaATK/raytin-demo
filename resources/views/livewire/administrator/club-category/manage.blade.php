                    ...
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('id')" class="px-1" x-show="clubCategoryID" x-transition x-cloak>
                                <x-administrator.icons-sort column="شناسه" columnEn="clubCategoryID" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            @foreach ($clubCategories as $clubCategory)
                                <livewire:administrator.club-category.table-row
                                    :$clubCategory
                                    :key="$clubCategory->clubCategoryID"
