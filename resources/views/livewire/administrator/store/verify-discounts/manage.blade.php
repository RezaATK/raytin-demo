                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="d-flex gap-1">
                            ...
                            <div class="ms-2" x-show="show" x-transition>
                                ...
                                <x-administrator.show-hide-column fieldId="UserLastName" fieldName="نام و نام خانوادگی کارمند" />
                                <x-administrator.show-hide-column fieldId="UserNationalCode" fieldName="کد ملی کارمند" />
                                <x-administrator.show-hide-column fieldId="UserMobileNumber" fieldName="شماره موبایل کارمند" />
                                <x-administrator.show-hide-column fieldId="UserEmploymentTypeName" fieldName="نوع استخدام" />
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('discountID')" class="px-1" x-show="discountID" x-transition x-cloak>
                                <x-administrator.icons-sort column="شناسه" columnEn="discountID" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('employeeID')" class="px-1" x-show="employeeID" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد پرسنلی" columnEn="employeeID" :$selectedColumn
                                                            :$descSort />
                            </th>
                            ...
                            <th wire:click="sort('UserLastName')" class="px-1" x-show="UserLastName" x-transition x-cloak>
                                <x-administrator.icons-sort column="نام و نام خانوادگی کارمند" columnEn="UserLastName" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('UserNationalCode')" class="px-1" x-show="UserNationalCode" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد ملی کارمند" columnEn="UserNationalCode" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('UserMobileNumber')" class="px-1" x-show="UserMobileNumber" x-transition x-cloak>
                                <x-administrator.icons-sort column="شماره موبایل کارمند" columnEn="UserMobileNumber" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('UserEmploymentTypeName')" class="px-1" x-show="UserEmploymentTypeName" x-transition x-cloak>
                                <x-administrator.icons-sort column="نوع استخدام" columnEn="UserEmploymentTypeName" :$selectedColumn
                                                            :$descSort />
                            </th>
                            ...
                            <th wire:click="sort('storeID')" class="px-1" x-show="storeID" x-transition x-cloak>
                                <x-administrator.icons-sort column="شناسه فروشگاه" columnEn="storeID" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('storeName')" class="px-1" x-show="storeName" x-transition x-cloak>
                                <x-administrator.icons-sort column="نام فروشگاه" columnEn="storeName" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('trackingCode')" class="px-1" x-show="trackingCode" x-transition x-cloak>
                                <x-administrator.icons-sort column="کد رهگیری" columnEn="trackingCode" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('discountDate')" class="px-1" x-show="discountDate" x-transition x-cloak>
                                <x-administrator.icons-sort column="برای تاریخ" columnEn="discountDate" :$selectedColumn
                                                            :$descSort />
                            </th>
                            <th wire:click="sort('additionalNote')" class="px-1" x-show="additionalNote" x-transition x-cloak>
                                <x-administrator.icons-sort column="ملاحظات" columnEn="additionalNote" :$selectedColumn
                                                            :$descSort />
                            </th>
                            ...
                            <th wire:click="sort('verification_two')" class="px-1" x-show="verification_two" x-transition x-cloak>
                                <x-administrator.icons-sort column="وضعیت" columnEn="verification_two" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            ...
                            <livewire:administrator.store.verify-discounts.table-row
                                :$storeDiscount
                                :key="$storeDiscount->discountID"
                                id="$storeDiscount->discountID"
                            />
                            @endforeach
                        @endif
                        </tbody>
