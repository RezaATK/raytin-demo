<div class="container">
    <h4 class="breadcrumb-wrapper">
        <span class="text-muted fw-light">خدمات رفاهی /</span> متصدی رفاهی
    </h4>
    <div class="card mt-4">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th wire:click="sort('UserMobileNumber')" class="px-1" x-show="UserMobileNumber"
                                    x-transition x-cloak>
                                    <x-administrator.icons-sort column="شماره موبایل کارمند" columnEn="UserMobileNumber"
                                        :$selectedColumn :$descSort />
                                </th>
                                ...
                                <th wire:click="sort('verification_one')" class="px-1" x-show="verification_one"
                                    x-transition x-cloak>
                                    <x-administrator.icons-sort column="وضعیت" columnEn="verification_one"
                                        :$selectedColumn :$descSort />
                                </th>
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($discounts as $storeDiscount)
                                    <livewire:administrator.store.all-discounts.table-row :$storeDiscount
