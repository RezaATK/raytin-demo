                    ...
                    <div class="col-sm-12 col-md-10">
                        <div class="d-flex gap-1">
                            ...
                            <div class="ms-2" x-show="show" x-transition>
                                ...
                                <x-administrator.show-hide-column fieldId="verification_one" fieldName="وضعیت" />
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('verification_one')" class="px-1" x-show="verification_one" x-transition x-cloak>
                                <x-administrator.icons-sort column="وضعیت" columnEn="verification_one" :$selectedColumn
                                                            :$descSort />
                            </th>
                        ...
                        @else
                            @foreach ($discounts as $storeDiscount)
                                <livewire:administrator.store.all-discounts.table-row
                                        :$storeDiscount
