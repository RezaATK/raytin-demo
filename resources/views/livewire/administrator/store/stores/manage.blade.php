                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-responsive-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th wire:click="sort('storeNeighborhood')" class="px-1" x-show="storeNeighborhood" x-transition
                                x-cloak>
                                <x-administrator.icons-sort column="محله" columnEn="storeNeighborhood" :$selectedColumn
                                                            :$descSort/>
                            </th>
                        ...
                        @else
                            @foreach ($stores as $store)
                                <livewire:administrator.store.stores.table-row
                                        :$store
                                        :key="$store->clubID"
                                        id="{{ $store->clubID }}"
                                />
